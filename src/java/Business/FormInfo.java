...
/**
 * A class that represents one form, of any type, in the the DeRiche
 * project.<br>This class holds all of the data contained within a form
 * including Base64 images from pictures that can be drawn on, TextFields, and
 * TextAreas.<br><br>
 * The class also contains preset {java.lang.String} arrays that represent all
 * the tags for any form in the DeRiche project.
 *
...
public class FormInfo {
    ...
    /**
     * This constructor is used locally in the static decode() method. No
     * implementation of this constructor should/can be used outside of this
     * class.
     */
    private FormInfo() {
    ...
    /**
     * Creates a new FormInfo object with Entry tags set to the values specified
     * by the type parameter passed.
     *
     * @param type the type of form as specified by the static final int values
     * in this class
     */
    ...
    /**
     * Sets the value for one Entry object to the passed parameter "value", as
     * specified by the "tag" parameter.
     *
     * @param tag the indentifier for the Entry object to which the value is to
     * be changed
     * @param value the value that will be used to assign to the tag, matching
     * the tag parameter passed, in the array of Entry objects
     */
    ...
    /**
     * Sets all entries in the order they are listed in the array of Entry
     * object to the corresponding values passed as the parameter as a
     * {java.lang.String} array.
     *
     * @param values the array of values that will be used to assign values to
     * all tags in the array of Entry objects
     */
    ...
    /**
     * Converts all the data in this FormInfo object to a single
     * {java.lang.String} which can be saved to a database.
     *
     * @return a encoded {java.lang.String} version of all the data held within
    ...
    /**
     * Converts an encoded {java.lang.String} to a new FormInfo object with all
     * of its tag/value pairs set to the values held within the encoded
     * {java.lang.String}.
     *
     * @param encodedString the {java.lang.String} that was encoded by the
     * encode() method
     * @return a FormInfo object with all of its values set to the values held
     * within the encoded {java.lang.String}
     */
    ...
    /**
     * Tells the encode() method whether or not the random characters generated
     * for the delimiter are suitable for use with the split() method in
     * {java.lang.String}.
     *
     * @param var the character to be checked against all known illegal
     * characters
     * @return a value telling whether or not the passed character is illegal to
     * use
     */
    ...
    /**
     * Sets all entries in the order they are listed in the array of Entry
     * object to the corresponding values passed as the parameter as an array.
     *
     * @param entries
     */
    ...
    /**
     * A class that represents one tag/value pair for any form in the the
     * DeRiche project.
     *
     * @author Cameron Randolph
     * @version 1.0
