...
public class Patient extends Access {
     ...
     *
     * Description dispaly will dispaly all the returns from the previous get
     * method : it will display Patient Id ,FirstName,LastName,Insurance,And
     * Medicaid .
     *
     ...
     * SelectDB() Method
     *
     * @Description This selectDB method select a patient by their patient ID
     * number
     * @param pID is Patient Id
     * @Author Carl Moon - Changed the local var to not match the global var.
...
****************************************************************************************
    ...
    /**
     * *****************************************************************************
     * @Description Insert method will put patient info into the DeRichie web
     * application.
     * @description Inserts into the Participant table.
     * @description Changed the local var's so that they were not the same as
     * the global
     * @description var's. I also corrected the number of place holders to match
     * the number of
     * @description var's being inserted into the database. Corrected int's to
     * strings.
     * @Author Carl Moon.
...
******************************************************************************
     ...
     * @ descrioption This will allow the administrator to update, the user
     * table in the in the DeRichie DB. Corrected int's to strings.
     * @ throws SQLException
     * @author Carl Moon
     * @deprecated
     * @ since 3-1-2017
     ...
     * @ description :user to update the user table with limited access in the
     * in the DeRichie DB.
...
****************************************************************************************
     ...
     * @ author Carl Moon
     * @since 3-2-17
     * @ description I corrected the tests for all database actions. The RUD's
     * of CRUD. I confirmed that the all database test work.Corrected , int's to
     * strings.
     * @ throws SQLException
     * @catch SQL EXception
     *
