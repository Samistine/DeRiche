...
public class User extends Access {
     ...
     *
     * @description it dispalys user id,user name,password,pin,first anme ,last
     * name,title,and clearense 
 ****************************************************************************************
     */
    public void display() {
     ...
     * SelectDB() Method
     *
     * @ description This selectDB method will go in to the Appointments table
     * in the Dentist DB.
     * @param un user id
     *
     * @throws SQLException
...
****************************************************************************************
     ...
     * updateDB() Method
     *
     * @description This updateDB method will allow a non admin user to update
     * the user table with limited access in the in the DeRichie DB.
     * @deprecated
****************************************************************************************
     */
    ...
    /**
     * ****************************************************************************************
     * deleteDB() Method This deleteDB method will go in to the Patients table
     * in the Dentist DB.
     *
     * @deprecated
****************************************************************************************
